...
2. **Now Playing** — Current market question (ET times converted to user's local timezone), bullish/bearish + price %, raw data values (heat, velocity, trade rate, spread), link to market
